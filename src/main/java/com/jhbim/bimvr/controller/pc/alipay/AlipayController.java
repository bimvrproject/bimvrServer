...
import com.jhbim.bimvr.stauts.unti.RSA;
...
public class AlipayController {
    ...
    public String notify(HttpServletRequest request) throws AlipayApiException, UnsupportedEncodingException {
        ...
        orders.setId(new String(request.getParameter("out_trade_no"))) ;
        // 验证请求参数,参数有问题返回错误提示
        if (flag) {
...
//        model.setOutRequestNo(UUID.randomUUID().toString());
    ...
    private String getOrderInfoByAliPay() {
        ...
        String seller_id = aliPayProperties.getAppid();//商户编号
        String returnUrl=aliPayProperties.getReturnUrl();
        String[] parameters={
                "String productCode = \"FAST_INSTANT_TRADE_PAY\"",
                "notify_url=\""+ali_call_back_url+"\"",//通知地址
                "notify_url=\""+returnUrl+"\"",
                "out_trade_no=\""+"123"+"\"",//商户内部订单号
                "subject=\"测试\"",//测试
    ...
    private String signAllString(String [] array){
        ...
        String sign = "";
        try {
            sign = URLEncoder.encode(RSA.sign(sb.toString(), aliPayProperties.getAppPrivateKey(), "utf-8"), "utf-8");//private_key私钥
